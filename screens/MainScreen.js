  ...
  return (
    <View style={styles.mainscreen}>
      <View style={styles.bgPosition}>
        ...
        <View style={[styles.logoutbtn, styles.idLayout]}>
          <View style={[styles.buttonbg, styles.idLayout]} />
      ...
      <View style={[styles.trashcard, styles.cardbgLayout]}>
        ...
        <View style={styles.trashid}>
          <Image
            ...
            contentFit="cover"
            source={require("../assets/trsh.png")}
          />
        ...
        <Image
          ...
          contentFit="cover"
          source={require("../assets/padlockopenned.png")}
        />
      </View>
      <Image
        style={[styles.padlockclosedIcon, styles.iconLayout]}
        contentFit="cover"
        source={require("../assets/padlockclosed.png")}
      />
    </View>
  );
};
